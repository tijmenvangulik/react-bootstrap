// Type definitions for react-bootstrap for es6 typescript. Use with react-bootstrap babel6 project https://github.com/tijmenvangulik/react-bootstrap
// Project: https://github.com/react-bootstrap/react-bootstrap
// Definitions by: Walker Burgin <https://github.com/walkerburgin>, Vincent Siao <https://github.com/vsiao> , Tijmen van Gulik <https://github.com/tijmenvangulik>
// Definitions: https://github.com/DefinitelyTyped/DefinitelyTyped

///<reference path="../react/react.d.ts"/>

declare namespace __ReactBootstrap {
...
declare module 'react-bootstrap/lib/ButtonToolbar' {
    export import ButtonToolbar = __ReactBootstrap.ButtonToolbar;
    export default ButtonToolbar;
}

declare module 'react-bootstrap/lib/Button' {
    export import Button = __ReactBootstrap.Button;
    export default Button;
}

declare module 'react-bootstrap/lib/ButtonGroup' {
    export import ButtonGroup = __ReactBootstrap.ButtonGroup;
    export default ButtonGroup;
}

declare module 'react-bootstrap/lib/DropdownButton' {
    export import DropdownButton = __ReactBootstrap.DropdownButton;
    export default DropdownButton;
}

declare module 'react-bootstrap/lib/SplitButton' {
    export import SplitButton = __ReactBootstrap.SplitButton;
    export default SplitButton;
}

declare module 'react-bootstrap/lib/MenuItem' {
    export import MenuItem = __ReactBootstrap.MenuItem;
    export default MenuItem;
}

declare module 'react-bootstrap/lib/Panel' {
    export import Panel = __ReactBootstrap.Panel;
    export default Panel;
}

declare module 'react-bootstrap/lib/PanelGroup' {
    export import PanelGroup = __ReactBootstrap.PanelGroup;
    export default PanelGroup;
}

declare module 'react-bootstrap/lib/ModalDialog' {
    export import ModalDialog = __ReactBootstrap.ModalDialog;
    export default ModalDialog;
}

declare module 'react-bootstrap/lib/ModalHeader' {
    export import ModalHeader = __ReactBootstrap.ModalHeader;
    export default ModalHeader;
}

declare module 'react-bootstrap/lib/ModalTitle' {
    export import ModalTitle = __ReactBootstrap.ModalTitle;
    export default ModalTitle;
}

declare module 'react-bootstrap/lib/ModalFooter' {
    export import ModalFooter = __ReactBootstrap.ModalFooter;
    export default ModalFooter;
}

declare module 'react-bootstrap/lib/Modal' {
    export import Modal = __ReactBootstrap.Modal;
    export default Modal;
}

declare module 'react-bootstrap/lib/Tooltip' {
    export import Tooltip = __ReactBootstrap.Tooltip;
    export default Tooltip;
}

declare module 'react-bootstrap/lib/OverlayTrigger' {
    export import OverlayTrigger = __ReactBootstrap.OverlayTrigger;
    export default OverlayTrigger;
}

declare module 'react-bootstrap/lib/Popover' {
    export import Popover = __ReactBootstrap.Popover;
    export default Popover;
}

declare module 'react-bootstrap/lib/Overlay' {
    export import Overlay = __ReactBootstrap.Overlay;
    export default Overlay;
}

declare module 'react-bootstrap/lib/ProgressBar' {
    export import ProgressBar = __ReactBootstrap.ProgressBar;
    export default ProgressBar;
}

declare module 'react-bootstrap/lib/Nav' {
    export import Nav = __ReactBootstrap.Nav;
    export default Nav;
}

declare module 'react-bootstrap/lib/NavItem' {
    export import NavItem = __ReactBootstrap.NavItem;
    export default NavItem;
}

declare module 'react-bootstrap/lib/NavbarBrand' {
    export import NavbarBrand = __ReactBootstrap.NavbarBrand;
    export default NavbarBrand;
}

declare module 'react-bootstrap/lib/NavbarCollapse' {
    export import NavbarCollapse = __ReactBootstrap.NavbarCollapse;
    export default NavbarCollapse;
}

declare module 'react-bootstrap/lib/NavbarToggle' {
    export import NavbarToggle = __ReactBootstrap.NavbarToggle;
    export default NavbarToggle;
}

declare module 'react-bootstrap/lib/Navbar' {
    export import Navbar = __ReactBootstrap.Navbar;
    export default Navbar;
}

declare module 'react-bootstrap/lib/NavDropdown' {
    export import NavDropdown = __ReactBootstrap.NavDropdown;
    export default NavDropdown;
}

declare module 'react-bootstrap/lib/Tabs' {
    export import Tabs = __ReactBootstrap.Tabs;
    export default Tabs;
}

declare module 'react-bootstrap/lib/Tab' {
    export import Tab = __ReactBootstrap.Tab;
    export default Tab;
}

declare module 'react-bootstrap/lib/PageItem' {
    export import PageItem = __ReactBootstrap.PageItem;
    export default PageItem;
}

declare module 'react-bootstrap/lib/Pagination' {
    export import Pagination = __ReactBootstrap.Pagination;
    export default Pagination;
}

declare module 'react-bootstrap/lib/Carousel' {
    export import Carousel = __ReactBootstrap.Carousel;
    export default Carousel;
}

declare module 'react-bootstrap/lib/CarouselItem' {
    export import CarouselItem = __ReactBootstrap.CarouselItem;
    export default CarouselItem;
}

declare module 'react-bootstrap/lib/Grid' {
    export import Grid = __ReactBootstrap.Grid;
    export default Grid;
}

declare module 'react-bootstrap/lib/Row' {
    export import Row = __ReactBootstrap.Row;
    export default Row;
}

declare module 'react-bootstrap/lib/Col' {
    export import Col = __ReactBootstrap.Col;
    export default Col;
}

declare module 'react-bootstrap/lib/Thumbnail' {
    export import Thumbnail = __ReactBootstrap.Thumbnail;
    export default Thumbnail;
}

declare module 'react-bootstrap/lib/ListGroup' {
    export import ListGroup = __ReactBootstrap.ListGroup;
    export default ListGroup;
}

declare module 'react-bootstrap/lib/ListGroupItem' {
    export import ListGroupItem = __ReactBootstrap.ListGroupItem;
    export default ListGroupItem;
}

declare module 'react-bootstrap/lib/Label' {
    export import Label = __ReactBootstrap.Label;
    export default Label;
}

declare module 'react-bootstrap/lib/Badge' {
    export import Badge = __ReactBootstrap.Badge;
    export default Badge;
}

declare module 'react-bootstrap/lib/Jumbotron' {
    export import Jumbotron = __ReactBootstrap.Jumbotron;
    export default Jumbotron;
}


declare module 'react-bootstrap/lib/PageHeader' {
    export import PageHeader = __ReactBootstrap.PageHeader;
    export default PageHeader;
}

declare module 'react-bootstrap/lib/Well' {
    export import Well = __ReactBootstrap.Well;
    export default Well;
}

declare module 'react-bootstrap/lib/Glyphicon' {
    export import Glyphicon = __ReactBootstrap.Glyphicon;
    export default Glyphicon;
}

declare module 'react-bootstrap/lib/Table' {
    export import Table = __ReactBootstrap.Table;
    export default Table;
}

declare module 'react-bootstrap/lib/Input' {
    export import Input = __ReactBootstrap.Input;
    export default Input;
}

declare module 'react-bootstrap/lib/ButtonInput' {
    export import ButtonInput = __ReactBootstrap.ButtonInput;
    export default ButtonInput;
}

declare module 'react-bootstrap/lib/FormControls/Static' {
    export import Static = __ReactBootstrap.Static;
    export default Static;
}

declare module 'react-bootstrap/lib/Portal' {
    export import Portal = __ReactBootstrap.Portal;
    export default Portal;
}

declare module 'react-bootstrap/lib/Position' {
    export import Position = __ReactBootstrap.Position;
    export default Position;
}

declare module 'react-bootstrap/lib/Fade' {
    export import Fade = __ReactBootstrap.Fade;
    export default Fade;
}
